...
<a href="https://drive.google.com/file/d/1c8QvgkL6TdWJtL3nV0ND4NNioBMk7e8v/view?usp=sharing" target="_blank" title="CV"><i class="ai ai-cv"></i></a>
  ...
  <article>
    ...
    <div> <!--class="clearfix">-->
      <p style="font-weight:bold">Hi! I’m Pan-Yang Su (蘇磐洋), an undergraduate student at <a href="https://web.ee.ntu.edu.tw/" target="_blank" rel="noopener">NTUEE</a>. My research orientations are game theory, algorithm, and quantum information theory. Specifically, I have the following research interests.</p>

<!--   <li> -->
<!--     <div class="row"> -->
   <p style="font-weight:bold; font-size:1em"> &#8226; Algorithmic Game Theory and Quantum Game Theory </p>
...
<!--       <p style="font-weight:bold; font-size:2em">Mechanism Design for Next-Generation Networks and Quantum Internet</p> -->
      <p style="font-weight:bold; font-size:1em"> &#8226; Mechanism Design for Next-Generation Networks and Quantum Internet </p>
<!--   </div> -->
<!--   </li> -->
...
<p style="font-weight:bold">I am working on the application of game theory in 5G Multicast and Broadcast Services, federated learning in mobile networks, and the relationship between correlated equilibria and quantum game theory. I desire to pursue a research career, and I am seeking opportunities to study for a Ph.D. starting from Fall 2022!</p>
      ...
      <table class="table table-sm table-borderless">
        ...
        <tr>
          ...
          <td>
              ...
              I am awarded Outstanding Performance Scholarship by NTU for the <a href="https://ieeexplore.ieee.org/document/9602884" target="_blank" rel="noopener">WOCC paper</a>!
...
<!-- <div id="chang2021towards" class="col-sm-11"> -->
    ...
    [<a href="https://ieeexplore.ieee.org/document/9602884" target="_blank">PDF</a>]
